...
namespace Melon.Components.News.UI.CodeBehind
{
    ...
    /// </para>
    /// <para>
    /// The language for which will be listed the latest news should be set in property <see cref="NewsListBase.Language"/>.
    /// </para>
    /// <para>
    /// If latest news from specific category should be listed then set the id of this category in property <see cref="NewsListBase.CategoryId"/>.
    /// </para>
    /// </remarks>
    public partial class LatestNews : MelonUserControl
    {
        ...
        /// <summary>
        /// Method to retrieve and display the latest news.
        /// </summary>
        /// <remarks>
        /// The method calls static method <see cref="News.ListLatest"/> to retrive the latest news and display them in 
        /// GridView gvNews.
        /// </remarks>
        public void NewsBind()
        {
            DataTable dtNews = News.ListLatest(this.CategoryId, this.Language, this.NewsCount);
