...
namespace Melon.Components.News.UI.CodeBehind
{
    ...
    /// <remarks>
    /// <para>
    ///     In the news list are displayed the following details: date published, author, title, summary. 
    ///     There is link "read more" which opens web page with news details which is configured by the developers in the configuration section of the component in the web config: news/frontEndInterface attribute newsDetailsPageUrl.
    /// </para>
    /// <para>
    /// The language for which will be listed the news should be set in property <see cref="NewsListBase.Language"/>.
    /// </para>
    /// <para>
    /// If the news from specific category should be listed then set the id of this category in property <see cref="NewsListBase.CategoryId"/>.
    /// </para>
    /// </remarks>
    public partial class NewsList : MelonUserControl
    {
        ...
        /// <summary>
        /// Method to retrieve and display news list.
        /// </summary>
        /// <remarks>
        /// The method calls static method <see cref="News.List(int?, CultureInfo)"/> to retrive the news 
        /// from specific category translated in specified language and display them in GridView gvNews.
        /// </remarks>
        public void NewsBind()
        {
            DataTable dtNews = News.List(this.CategoryId, this.Language);
