...
namespace Melon.Components.News.UI.CodeBehind
{
    ...
    /// </para>
    /// <para>
    /// The language for which will be listed the featured news should be set in property <see cref="NewsListBase.Language"/>.
    /// </para>
    /// <para>
    /// If featured news from specific category should be listed then set the id of this category in property <see cref="NewsListBase.CategoryId"/>.
    /// </para>
    /// </remarks>
    public partial class FeaturedNews : MelonUserControl
    {
        ...
        /// <summary>
        /// Method to retrieve and display the featured news.
        /// </summary>
        /// <remarks>
        /// The method calls static method <see cref="News.ListFeatured"/> to retrive the featured news and display them in 
        /// GridView gvNews.
        /// </remarks>
        public void NewsBind()
        {
            DataTable dtNews = News.ListFeatured(this.CategoryId, this.Language, this.NewsCount);
