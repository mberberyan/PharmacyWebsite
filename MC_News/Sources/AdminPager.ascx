<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdminPager.ascx.cs" Inherits="Melon.Components.News.UI.CodeBehind.AdminPager" %>
        ...
        <table id="tblPageDetails" runat="server" cellpadding="0" cellspacing="0" border="0"
            ...
            <tr>
                <td width="50%" align="left">
                    ...
                    <asp:Label ID="lblPage" runat="server" meta:resourcekey="lblPage" CssClass="mc_news_pager_lbl"/>
                ...
                <td width="50%" align="right">
                    <asp:LinkButton ID="lbtnPreviousPage" runat="server" CausesValidation="False" Visible="False"
                        meta:resourcekey="lbPreviousPage" CssClass="mc_news_previous" />
                    &nbsp;
                    <asp:LinkButton ID="lbtnNextPage" runat="server" CausesValidation="False" Visible="False"
                        meta:resourcekey="lbNextPage"  CssClass="mc_news_next"/>
                </td>
            </tr>
        </table>
    </div>
