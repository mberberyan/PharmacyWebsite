<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Pager.ascx.cs" Inherits="Melon.Components.ProductCatalog.UI.CodeBehind.CodeBehind_Pager" %>

<div id="divPager" runat="server" class="mc_pc_pager_wrapper">
        ...
        <table id="tblPageDetails" runat="server" cellpadding="0" cellspacing="0" border="0"
            ...
            <tr>
                <td width="50%" align="left">
                    ...
                    <asp:Label ID="lblPage" runat="server" meta:resourcekey="lblPage" CssClass="mc_pc_pager_lbl"/>
                ...
                <td width="50%" align="right">
                    <asp:LinkButton ID="lbtnPreviousPage" runat="server" CausesValidation="False" Visible="False"
                        meta:resourcekey="lbPreviousPage" CssClass="mc_pc_previous" />
                    &nbsp;
                    <asp:LinkButton ID="lbtnNextPage" runat="server" CausesValidation="False" Visible="False"
                        meta:resourcekey="lbNextPage" CssClass="mc_pc_next" />
                </td>
            </tr>
        </table>
    </div>
